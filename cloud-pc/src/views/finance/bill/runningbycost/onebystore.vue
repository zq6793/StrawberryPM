<template>
  <section class="all-box">
    ...
    <el-table :data="billFlows" @selection-change="selsChange" style="width: 100%;" v-loading="listLoading" border>
      ...
      <el-table-column prop="deposit" label="周期" align="center">
      </el-table-column>
...
import { billListCostStore, CostStoreExcel } from '@/api/api'
export default {
  components: {
    CityStoreSelect,
    DateIntervalSelect,
  ...
  methods: {
    ...
    getBillflow() {
      ...
      billListCostStore(para).then(res => {

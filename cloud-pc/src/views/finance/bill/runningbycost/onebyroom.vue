<template>
  <section class="all-box">
    ...
    <el-table :data="billFlows" @selection-change="selsChange" style="width: 100%;" v-loading="listLoading" border>
      ...
      <el-table-column prop="" label="周期" align="center">
      </el-table-column>
      ...
      <el-table-column prop="temp_fee" label="临时收费" align="center">
      </el-table-column>
...
import { billListCostRoom, CostRoomExcel } from '@/api/api'
export default {
  components: {
    CityStoreSelect,
    DateIntervalSelect,
  ...
  methods: {
    ...
    getBillflow() {
      ...
      billListCostRoom(para).then(res => {

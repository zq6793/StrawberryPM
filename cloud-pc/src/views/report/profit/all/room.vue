  ...
  <section class="all-box">
    <el-form :inline="true" class="fx-table-sort-head">
      <el-form-item size="small">
        <el-radio-group v-model="tabbyname" @change="tabChange">
          ...
          <el-radio-button label="可视化"></el-radio-button>
        </el-radio-group>
      </el-form-item>
    ...
    <el-table :data="billFlows" @selection-change="selsChange" style="width: 100%;" v-loading="listLoading" border>
     <el-table-column prop="store_name" label="门店名称" width="190" align="center">
      ...
      <el-table-column prop="room_number" label="房间号" width="190" align="center">
      </el-table-column>
      <el-table-column label="住宿费" align="center">
        <el-table-column prop="pay_ways" label="收入" align="center">
        </el-table-column>
        <el-table-column prop="pay_ways" label="支出" align="center">
        </el-table-column>
        <el-table-column prop="pay_ways" label="利润" align="center">
        </el-table-column>
        <el-table-column prop="pay_ways" label="利润率" align="center">
        </el-table-column>
      </el-table-column>
  ...
  methods: {
    tabChange() {
      switch (this.tabbyname) {
        case '门店' :
          this.$emit('set', 'summary', 'store')
          break
        case '可视化' :
          this.$emit('set', 'summary', 'storeshow')
          break
        case '房间' :
          this.$emit('set', 'summary', 'room')
          break
        default :
          this.$emit('set', 'summary', 'store')
          break

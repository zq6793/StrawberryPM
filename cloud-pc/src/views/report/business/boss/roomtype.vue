<template>
  <section class="all-box">
    ...
    <el-table :data="billFlows" @selection-change="selsChange" style="width: 100%;" v-loading="listLoading" border>
      ...
      <el-table-column prop="room_type_name" label="户型名称" width="190" align="center">
      </el-table-column>
      <el-table-column prop="room_count" label="户型间数" align="center">
      </el-table-column>
...
import { chartOperationRoomType, operationRoomTypeExcel } from '@/api/api'
export default {
  components: {
    CityStoreSelect,
    DateIntervalSelect,
  ...
  methods: {
    ...
    getBillflow() {
      ...
      chartOperationRoomType(para).then(res => {
    ...
    handleExports () {
      ...
      that.$confirm('确认导出选中记录吗？', '提示', {
        ...
        operationRoomTypeExcel(para).then((res) => {
